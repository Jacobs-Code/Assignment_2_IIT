...
var hobbies = [
    ["Coding", "I often code websites, games, and systems, gaining awards for many of my projects. I have learnt coding languages including;  <ul> <li> JavaScript (HTML, CSS)</li> <li> Python </li> <li> SQL (PHP)</li> <li> C* ( C++)</li> <li> R (RStudio data analysis)</li></ul> I have learnt the best way to learn new skills is through practice. This can be seen through my previous work which you can see here: <a style = 'color: white' href='portfolio.html'>Portfolio</a>"],
    ["Engineering", "I often apply my coding knowledge in real word situations. The prime example of this is an automatic aquarium with a mechanical 3D printed system controlled by a motor. Through my exploration of engineering I have gained skills in <ul><li>3D Printing</li><li>Electrical Engineering</li><li>3D Modelling</li><li>And more</li></ul> "],
    ...
    for(var i = 0; i < hobbies.length; i++){
        document.getElementById("hobbies").innerHTML += `
            <div class = "hobby" onclick = "renderInformation(${i})">
                <img class = "photos" src = "Images/maxresdefault.jpg"/>
                <h3>${hobbies[i][0]}</h3>
                <h4>More</h4>                    
            </div>
        `
